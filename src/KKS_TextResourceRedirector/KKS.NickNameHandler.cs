...
namespace IllusionMods
{
    ...
    public partial class NickNameHandler : RedirectorAssetLoadedHandlerBase<NickName>
    {
        ...
        internal static class Hooks
        {
            ...
            [HarmonyPostfix]
            [HarmonyPatch(typeof(SaveData.WorldData), nameof(SaveData.WorldData.CallNormalize))]
            ...
            [HarmonyPostfix]
            [HarmonyPatch(typeof(SaveData.WorldData), nameof(SaveData.WorldData.FindCallFileData), typeof(int), typeof(int))]
            internal static void SaveDataFindCallFileDataPostfix(SaveData.WorldData.CallFileData __result, int personality,
                int id)
            {
                ...
                try
                {
                    ...
                    var nickParam = SaveData.WorldData.GetCallName(personality, id);
